...
public class AdminSample {
    ...
    public final static String TOPIC_NAME="guilin-topic";
...
//        AlterConfigsResult alterConfigsResult = adminClient.alterConfigs(configMaps);
    ...
    /*
        查看配置信息
        ConfigResource(type=TOPIC, name='guilin-topic') ,
        Config(
            entries=[
             ConfigEntry(
...
//        ConfigResource configResource = new ConfigResource(ConfigResource.Type.BROKER, TOPIC_NAME);
    ...
    /*
        描述Topic
        name ：guilin-topic ,
        desc: (name=guilin-topic,
            internal=false,
            partitions=
                (partition=0,
                 leader=192.168.1.252:9092
                 (id: 0 rack: null),
                 replicas=192.168.1.252:9092
                 (id: 0 rack: null),
                 isr=192.168.1.252:9092
                 (id: 0 rack: null)),
...
//        ListTopicsResult listTopicsResult = adminClient.listTopics();
    ...
    public static AdminClient adminClient(){
        ...
        properties.setProperty(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG,"192.168.1.252:9092");
