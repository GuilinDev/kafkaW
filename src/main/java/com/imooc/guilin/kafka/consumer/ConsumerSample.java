package com.imooc.guilin.kafka.consumer;
...
public class ConsumerSample {
    private final static String TOPIC_NAME="guilin-topic";
...
//        helloworldWithSSL();
    ...
    private static void helloworldWithSSL(){
        ...
        props.setProperty("bootstrap.servers", "192.168.1.252:8989");
        ...
        props.put("ssl.truststore.password","guilin");
    ...
    private static void helloworld(){
        Properties props = new Properties();
        props.setProperty("bootstrap.servers", "192.168.1.252:9092");
        props.setProperty("group.id", "test");
        props.setProperty("enable.auto.commit", "true");
        props.setProperty("auto.commit.interval.ms", "1000");
        props.setProperty("key.deserializer", "org.apache.kafka.common.serialization.StringDeserializer");
    ...
    private static void commitedOffset() {
        ...
        props.setProperty("auto.commit.interval.ms", "1000"); // enable.auto.commit设置false这个不需要
        props.setProperty("key.deserializer", "org.apache.kafka.common.serialization.StringDeserializer");
        props.setProperty("value.deserializer", "org.apache.kafka.common.serialization.StringDeserializer");
